...
return [
    ...
    | pela classe do validador. Algumas dessas regras têm várias versões, como
    ...
    */
    ...
    | Isso agiliza a especificação de uma linha de idioma personalizada
    ...
    */
    ...
    | reservado de atributo por algo mais fácil de ler, como "Endereço de
    | Email" em vez de "email". Isso simplesmente nos ajuda a tornar nossa
